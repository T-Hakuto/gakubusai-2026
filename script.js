...
if (portalLinkContainer) {
  const portalSections = [
    { title: '企画特設ページ', links: [['夏祭り', '8/11'], ['24時間テレビ', '9/26–27'], ['コンパ', '10/5'], ['決起集会', '11/11'], ['古本市', '']] },
  ...
  portalSections.forEach((section, index) => {
    ...
    section.links.forEach(([label, date]) => {
      const link = document.createElement('a'); link.href = `#${label.replace(/[^a-zA-Z0-9]/g, '') || 'page'}`;
